...
namespace vlr {
    ...
    MPCController::MPCController() : nh_(), received_applanix_state_(false),received_trajectory_(false), 
        ...
        if (sim_flag){
            controller_target_pub_  = nh_.advertise<path_follower::ControllerTarget>("ControllerTarget_sim", 1);
            steering_pub_ = nh_.advertise<path_follower::SteeringCmd>("path_follower/steering_cmd_sim",1);
            twist_pub_ = nh_.advertise<geometry_msgs::TwistStamped>("twist_cmd_sim", 1);
            s_next_pub_ = nh_.advertise<path_follower::ApplanixPose>("s_next_sim", 30);
            s_close_pub_ = nh_.advertise<path_follower::ApplanixPose>("s_close_sim",30);
            des_traj_pub_ =nh_.advertise<path_follower::traj_plan>("des_traj_sim",30);
            applanix_pub_ = nh_.advertise<path_follower::ApplanixPose>("Applanix_sim",30);
            Uout_pub_ = nh_.advertise<path_follower::Uout>("Uout_sim",50);
            time_pub_ = nh_.advertise<path_follower::Time>("Time_sim",30);
            steering_current_pub_ = nh_.advertise<path_follower::SteeringCurrent>("path_follower/steering_current_sim",1);
        }
        else {
