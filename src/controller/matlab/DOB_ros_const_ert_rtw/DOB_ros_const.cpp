...
void DOB_ros_const_step(void)
{
   ...
   *  Gain: '<Root>/Gain3'
   */
  rtb_Sum3_o = DOB_ros_const_P.kc12 * DOB_ros_const_B.In1_i.Dy +
    DOB_ros_const_P.kc11 * DOB_ros_const_B.In1_i.Dtheta;

  /* Lookup_n-D: '<S5>/2-D Lookup Table' */
  rtb_Sum1 = look2_iflf_pbinlxpw(DOB_ros_const_B.In1_i.Vx,
    DOB_ros_const_B.In1_i.Dtheta, DOB_ros_const_P.vx_list,
    DOB_ros_const_P.dphi_list, DOB_ros_const_P.b0, DOB_ros_const_DW.m_bpIndex,
    DOB_ros_const_P.uDLookupTable_maxIndex, 2U);

  /* Sum: '<S12>/Sum1' incorporates:
   *  Product: '<S12>/Product1'
   *  UnitDelay: '<S12>/Delay1'
   */
  rtb_Sum1 = rtb_Sum3_o * rtb_Sum1 + DOB_ros_const_DW.Delay1_DSTATE;

  /* Sum: '<Root>/Sum4' incorporates:
   *  Delay: '<Root>/Delay1'
   */
  rtb_Sum4 = DOB_ros_const_DW.Delay1_DSTATE_a[0] - rtb_Sum1;

  /* DiscreteTransferFcn: '<Root>/Q1' */
  Q1_tmp = ((rtb_Sum4 - DOB_ros_const_P.Q1_DenCoef[1] *
  ...
  if (b_varargout_1) {
    ...
    rtb_BusAssignment_o.DCancel = (DOB_ros_const_P.Q1_NumCoef[0] * Q1_tmp +
      DOB_ros_const_P.Q1_NumCoef[1] * DOB_ros_const_DW.Q1_states[0]) +
   ...
   *  Gain: '<Root>/Gain5'
   */
  rtb_Sum4 = 0.0F - DOB_ros_const_P.kc2 * rtb_Sum3_o;
  ...
  if (b_varargout_1) {
    /* Gain: '<S2>/Gain1' */
    rtb_Q1 = DOB_ros_const_P.steering_ratio * rtb_Sum4;
  ...
  rtb_Q1 = look2_iflf_pbinlxpw(DOB_ros_const_B.In1_i.Vx,
    DOB_ros_const_B.In1_i.Dtheta, DOB_ros_const_P.vx_list,
    DOB_ros_const_P.dphi_list, DOB_ros_const_P.b1, DOB_ros_const_DW.m_bpIndex_p,
    DOB_ros_const_P.uDLookupTable2_maxIndex, 2U);

  /* Lookup_n-D: '<S5>/2-D Lookup Table5' */
  rtb_uDLookupTable5 = look2_iflf_pbinlxpw(DOB_ros_const_B.In1_i.Vx,
    DOB_ros_const_B.In1_i.Dtheta, DOB_ros_const_P.vx_list,
    DOB_ros_const_P.dphi_list, DOB_ros_const_P.b3, DOB_ros_const_DW.m_bpIndex_j,
    DOB_ros_const_P.uDLookupTable5_maxIndex, 2U);

  /* Lookup_n-D: '<S5>/2-D Lookup Table7' */
  rtb_uDLookupTable7 = look2_iflf_pbinlxpw(DOB_ros_const_B.In1_i.Vx,
    DOB_ros_const_B.In1_i.Dtheta, DOB_ros_const_P.vx_list,
    DOB_ros_const_P.dphi_list, DOB_ros_const_P.a3, DOB_ros_const_DW.m_bpIndex_b,
    DOB_ros_const_P.uDLookupTable7_maxIndex, 2U);

  /* Lookup_n-D: '<S5>/2-D Lookup Table8' */
  rtb_uDLookupTable8 = look2_iflf_pbinlxpw(DOB_ros_const_B.In1_i.Vx,
    DOB_ros_const_B.In1_i.Dtheta, DOB_ros_const_P.vx_list,
    DOB_ros_const_P.dphi_list, DOB_ros_const_P.b5, DOB_ros_const_DW.m_bpIndex_o,
    DOB_ros_const_P.uDLookupTable8_maxIndex, 2U);
   ...
   */
  DOB_ros_const_DW.Delay1_DSTATE = (rtb_Sum3_o * rtb_Q1 +
    DOB_ros_const_DW.Delay2_DSTATE) - rtb_Sum1 * look2_iflf_binlxpw
    (DOB_ros_const_B.In1_i.Vx, DOB_ros_const_B.In1_i.Dtheta,
     DOB_ros_const_P.vx_list, DOB_ros_const_P.dphi_list, DOB_ros_const_P.a1,
     DOB_ros_const_P.uDLookupTable1_maxIndex, 2U);

  /* Update for Delay: '<Root>/Delay1' */
  DOB_ros_const_DW.Delay1_DSTATE_a[0] = DOB_ros_const_DW.Delay1_DSTATE_a[1];
  DOB_ros_const_DW.Delay1_DSTATE_a[1] = rtb_Sum4;

  /* Update for DiscreteTransferFcn: '<Root>/Q1' */
  DOB_ros_const_DW.Q1_states[1] = DOB_ros_const_DW.Q1_states[0];
  DOB_ros_const_DW.Q1_states[0] = Q1_tmp;
   ...
   */
  DOB_ros_const_DW.Delay2_DSTATE = (rtb_Sum3_o * look2_iflf_binlxpw
    (DOB_ros_const_B.In1_i.Vx, DOB_ros_const_B.In1_i.Dtheta,
     DOB_ros_const_P.vx_list, DOB_ros_const_P.dphi_list, DOB_ros_const_P.b2,
     DOB_ros_const_P.uDLookupTable4_maxIndex, 2U) +
    DOB_ros_const_DW.Delay3_DSTATE) - rtb_Sum1 * look2_iflf_binlxpw
    (DOB_ros_const_B.In1_i.Vx, DOB_ros_const_B.In1_i.Dtheta,
     DOB_ros_const_P.vx_list, DOB_ros_const_P.dphi_list, DOB_ros_const_P.a2,
     DOB_ros_const_P.uDLookupTable3_maxIndex, 2U);
   ...
   */
  DOB_ros_const_DW.Delay3_DSTATE = (rtb_Sum3_o * rtb_uDLookupTable5 +
    DOB_ros_const_DW.Delay4_DSTATE) - rtb_Sum1 * rtb_uDLookupTable7;
   ...
   */
  DOB_ros_const_DW.Delay4_DSTATE = (rtb_Sum3_o * look2_iflf_binlxpw
    (DOB_ros_const_B.In1_i.Vx, DOB_ros_const_B.In1_i.Dtheta,
     DOB_ros_const_P.vx_list, DOB_ros_const_P.dphi_list, DOB_ros_const_P.b4,
     DOB_ros_const_P.uDLookupTable6_maxIndex, 2U) +
    DOB_ros_const_DW.Delay5_DSTATE) - rtb_Sum1 * DOB_ros_const_P.Constant1_Value;
   ...
   *  Sum: '<S12>/Sum6'
   */
  DOB_ros_const_DW.Delay5_DSTATE = rtb_Sum3_o * rtb_uDLookupTable8 - rtb_Sum1 *
    DOB_ros_const_P.Constant_Value_o;
}
...
void DOB_ros_const_initialize(void)
{
  ...
  DOB_ros_const_DW.Delay1_DSTATE = DOB_ros_const_P.Delay1_InitialCondition;

  /* InitializeConditions for Delay: '<Root>/Delay1' */
  DOB_ros_const_DW.Delay1_DSTATE_a[0] =
    DOB_ros_const_P.Delay1_InitialCondition_p;

  /* InitializeConditions for DiscreteTransferFcn: '<Root>/Q1' */
  DOB_ros_const_DW.Q1_states[0] = DOB_ros_const_P.Q1_InitialStates;

  /* InitializeConditions for Delay: '<Root>/Delay1' */
  DOB_ros_const_DW.Delay1_DSTATE_a[1] =
    DOB_ros_const_P.Delay1_InitialCondition_p;
  ...
  DOB_ros_const_DW.Delay3_DSTATE = DOB_ros_const_P.Delay3_InitialCondition;

  /* InitializeConditions for UnitDelay: '<S12>/Delay4' */
  DOB_ros_const_DW.Delay4_DSTATE = DOB_ros_const_P.Delay4_InitialCondition;

  /* InitializeConditions for UnitDelay: '<S12>/Delay5' */
  DOB_ros_const_DW.Delay5_DSTATE = DOB_ros_const_P.Delay5_InitialCondition;
