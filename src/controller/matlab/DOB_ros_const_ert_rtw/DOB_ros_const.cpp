...
void DOB_ros_const_step(void)
{
   ...
   *  Gain: '<Root>/Gain3'
   */
  rtb_Sum3 = DOB_ros_const_P.kc12 * DOB_ros_const_B.In1_i.Dy +
   ...
   *  DiscreteTransferFcn: '<Root>/Q1'
   */
  D1_tmp = rtb_Sum3 - DOB_ros_const_P.Dd[1] * DOB_ros_const_DW.D1_states[0];
  denIdx = 2;
  for (j = 0; j < 4; j++) {
  ...
  if (b_varargout_1) {
    ...
    rtb_BusAssignment_o.DCancel = (DOB_ros_const_P.Q1_NumCoef[0] * rtb_D1 +
  ...
  if (b_varargout_1) {
    ...
    rtb_BusAssignment.SteeringWheelAngleVelocity = 1.0F /
      DOB_ros_const_P.dt_ros_single * (rtb_Sum4 -
  ...
  DOB_ros_const_DW.Delay1_DSTATE[1] = rtb_Sum3;
