...
void DOB_ros_step(void)
{
  ...
  SL_Bus_DOB_ros_dbw_mkz_msgs_SteeringCmd rtb_BusAssignment_l;
  real32_T rtb_Sum3;
  real32_T rtb_Q1;
  real32_T Q1_tmp;
  real32_T D1_tmp;
   ...
   *  Gain: '<Root>/Gain3'
   */
  rtb_Sum3 = (real32_T)(DOB_ros_P.kc1 * DOB_ros_B.In1_i.Theta) + (real32_T)
    DOB_ros_B.In1_i.Y;
   ...
   *  Sum: '<Root>/Sum4'
   */
  Q1_tmp = (((DOB_ros_DW.Delay1_DSTATE[0] - rtb_Q1) - DOB_ros_P.Q1_DenCoef[1] *
   ...
   *  Gain: '<Root>/Gain5'
   */
  rtb_Q1 = ((DOB_ros_P.Q1_NumCoef[0] * Q1_tmp + DOB_ros_P.Q1_NumCoef[1] *
  ...
  if (b_varargout_1) {
     ...
     *  Sum: '<S1>/Subtract'
     */
    rtb_BusAssignment_l = DOB_ros_P.Constant_Value_jb;
    rtb_BusAssignment_l.SteeringWheelAngleCmd = rtb_Q1;
    rtb_BusAssignment_l.SteeringWheelAngleVelocity = (rtb_Q1 -
      DOB_ros_B.In1.SteeringWheelAngle) * DOB_ros_P.Gain_Gain;

    /* Outputs for Atomic SubSystem: '<S1>/Publish' */
    /* Start for MATLABSystem: '<S6>/SinkBlock' */
    Pub_DOB_ros_152.publish(&rtb_BusAssignment_l);
  ...
  DOB_ros_DW.Delay1_DSTATE[1] = rtb_Q1;
...
void DOB_ros_initialize(void)
{
...

  {
    ...
    static const char_T tmp_0[13] = { '/', 's', 't', 'e', 'e', 'r', 'i', 'n',
      'g', '_', 'c', 'm', 'd' };
    ...
    static const char_T tmp_2[15] = { '/', 't', 'r', 'a', 'c', 'k', 'i', 'n',
      'g', '_', 'e', 'r', 'r', 'o', 'r' };
    ...
    tmp_4[24] = '\x00';
    Sub_DOB_ros_191.createSubscriber(tmp_4, DOB_ros_MessageQueueLen);
    ...
    tmp_4[24] = '\x00';
    Pub_DOB_ros_158.createPublisher(tmp_4, DOB_ros_MessageQueueLen);
