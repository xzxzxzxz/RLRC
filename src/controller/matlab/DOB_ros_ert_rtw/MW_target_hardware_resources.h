...
#define MW_PACKAGING_MAINTAINERNAME Chen Tang
#define MW_PACKAGING_MAINTAINEREMAIL chen_tang@berkeley.edu
#define MW_PACKAGING_LICENSE BSD
#define MW_PACKAGING_VERSION 1.0.0
#define MW_BOARDPARAMETERS_DEVICEADDRESS 10.142.97.137
#define MW_BOARDPARAMETERS_USERNAME chen
#define MW_RUNTIME_BUILDACTION 1
#define MW_ROS_INSTALL /opt/ros/kinetic
#define MW_ROS_CATKINWS ~/ProjectCodes/RLRC/RLRC/
