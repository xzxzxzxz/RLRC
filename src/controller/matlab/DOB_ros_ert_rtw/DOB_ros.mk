...
## 
## Makefile     : DOB_ros.mk
## Generated on : Sat Jan 12 11:42:23 2019
## MATLAB Coder version: 3.4 (R2017b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/DOB_ros.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/DOB_ros.elf
...
%.c.o : $(START_DIR)/DOB_ros_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.s.o : $(START_DIR)/DOB_ros_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<


%.cpp.o : $(START_DIR)/DOB_ros_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<
