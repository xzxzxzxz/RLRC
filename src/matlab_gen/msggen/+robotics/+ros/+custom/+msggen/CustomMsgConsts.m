classdef CustomMsgConsts
    ...
    properties (Constant)
        controller_TrackingInfo = 'controller/TrackingInfo'
    ...
    methods (Static, Hidden)
        function messageList = getMessageList
            ...
            if isempty(msgList)
                msgList = cell(41, 1);
                msgList{1} = 'controller/TrackingInfo';
                msgList{2} = 'dbw_mkz_msgs/AmbientLight';
                msgList{3} = 'dbw_mkz_msgs/BrakeCmd';
                msgList{4} = 'dbw_mkz_msgs/BrakeInfoReport';
                msgList{5} = 'dbw_mkz_msgs/BrakeReport';
                msgList{6} = 'dbw_mkz_msgs/FuelLevelReport';
                msgList{7} = 'dbw_mkz_msgs/Gear';
                msgList{8} = 'dbw_mkz_msgs/GearCmd';
                msgList{9} = 'dbw_mkz_msgs/GearReject';
                msgList{10} = 'dbw_mkz_msgs/GearReport';
                msgList{11} = 'dbw_mkz_msgs/HillStartAssist';
                msgList{12} = 'dbw_mkz_msgs/Misc1Report';
                msgList{13} = 'dbw_mkz_msgs/ParkingBrake';
                msgList{14} = 'dbw_mkz_msgs/SteeringCmd';
                msgList{15} = 'dbw_mkz_msgs/SteeringReport';
                msgList{16} = 'dbw_mkz_msgs/SurroundReport';
                msgList{17} = 'dbw_mkz_msgs/ThrottleCmd';
                msgList{18} = 'dbw_mkz_msgs/ThrottleInfoReport';
                msgList{19} = 'dbw_mkz_msgs/ThrottleReport';
                msgList{20} = 'dbw_mkz_msgs/TirePressureReport';
                msgList{21} = 'dbw_mkz_msgs/TurnSignal';
                msgList{22} = 'dbw_mkz_msgs/TurnSignalCmd';
                msgList{23} = 'dbw_mkz_msgs/TwistCmd';
                msgList{24} = 'dbw_mkz_msgs/WatchdogCounter';
                msgList{25} = 'dbw_mkz_msgs/WheelPositionReport';
                msgList{26} = 'dbw_mkz_msgs/WheelSpeedReport';
                msgList{27} = 'dbw_mkz_msgs/Wiper';
                msgList{28} = 'path_follower/Actuator';
                msgList{29} = 'path_follower/ApplanixPose';
                msgList{30} = 'path_follower/ControllerTarget';
                msgList{31} = 'path_follower/SteeringCmd';
                msgList{32} = 'path_follower/SteeringCurrent';
                msgList{33} = 'path_follower/Time';
                msgList{34} = 'path_follower/Trajectory2D';
                msgList{35} = 'path_follower/TrajectoryPoint2D';
                msgList{36} = 'path_follower/TwistStamped';
                msgList{37} = 'path_follower/Uout';
                msgList{38} = 'path_follower/dtlane';
                msgList{39} = 'path_follower/state_Dynamic';
                msgList{40} = 'path_follower/traj_plan';
                msgList{41} = 'path_follower/waypoint';
            end
