classdef ThrottleReport < robotics.ros.Message
    ...
    properties (Constant, Hidden)
        MD5Checksum = 'dc371d36db36a47de2ffaa1302bf4aec' % The MD5 Checksum of the message definition
    end
    ...
    properties (Constant, Hidden)
        PropertyList = {'Driver', 'Enabled', 'FaultCh1', 'FaultCh2', 'FaultWdc', 'Header', 'Override', 'PedalCmd', 'PedalInput', 'PedalOutput', 'Timeout', 'WatchdogCounter'} % List of non-constant message properties
        ROSPropertyList = {'driver', 'enabled', 'fault_ch1', 'fault_ch2', 'fault_wdc', 'header', 'override', 'pedal_cmd', 'pedal_input', 'pedal_output', 'timeout', 'watchdog_counter'} % List of non-constant ROS message properties
    end
    ...
    methods
        ...
        function set.Timeout(obj, timeout)
            ...
            validateattributes(timeout, {'logical', 'numeric'}, {'nonempty', 'scalar'}, 'ThrottleReport', 'Timeout');
