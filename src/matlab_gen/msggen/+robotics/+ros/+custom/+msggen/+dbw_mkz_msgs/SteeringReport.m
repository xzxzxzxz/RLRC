classdef SteeringReport < robotics.ros.Message
    ...
    properties (Constant, Hidden)
        MD5Checksum = '435efc512abdd87ef2f942c0e8ed296d' % The MD5 Checksum of the message definition
    end
    ...
    properties (Constant, Hidden)
        PropertyList = {'Enabled', 'FaultBus1', 'FaultBus2', 'FaultCalibration', 'FaultWdc', 'Header', 'Override', 'Speed', 'SteeringWheelAngle', 'SteeringWheelAngleCmd', 'SteeringWheelTorque', 'Timeout'} % List of non-constant message properties
        ROSPropertyList = {'enabled', 'fault_bus1', 'fault_bus2', 'fault_calibration', 'fault_wdc', 'header', 'override', 'speed', 'steering_wheel_angle', 'steering_wheel_angle_cmd', 'steering_wheel_torque', 'timeout'} % List of non-constant ROS message properties
    end
    ...
    methods
        ...
        function set.Timeout(obj, timeout)
            ...
            validateattributes(timeout, {'logical', 'numeric'}, {'nonempty', 'scalar'}, 'SteeringReport', 'Timeout');
