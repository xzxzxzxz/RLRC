classdef BrakeCmd < robotics.ros.Message
    ...
    properties (Constant, Hidden)
        MD5Checksum = 'c0d20e1056976680942e85ab0959826c' % The MD5 Checksum of the message definition
    end
    ...
    properties (Constant, Hidden)
        PropertyList = {'BooCmd', 'Clear', 'Count', 'Enable', 'Ignore', 'PedalCmd', 'PedalCmdType'} % List of non-constant message properties
        ROSPropertyList = {'boo_cmd', 'clear', 'count', 'enable', 'ignore', 'pedal_cmd', 'pedal_cmd_type'} % List of non-constant ROS message properties
    end
    ...
    methods
        ...
        function set.Clear(obj, clear)
            ...
            validateattributes(clear, {'logical', 'numeric'}, {'nonempty', 'scalar'}, 'BrakeCmd', 'Clear');
