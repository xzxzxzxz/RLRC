classdef ThrottleCmd < robotics.ros.Message
    ...
    properties (Constant, Hidden)
        MD5Checksum = 'd75259a1444adebea30e45b37542c415' % The MD5 Checksum of the message definition
    end
    ...
    properties (Constant, Hidden)
        PropertyList = {'Clear', 'Count', 'Enable', 'Ignore', 'PedalCmd', 'PedalCmdType'} % List of non-constant message properties
        ROSPropertyList = {'clear', 'count', 'enable', 'ignore', 'pedal_cmd', 'pedal_cmd_type'} % List of non-constant ROS message properties
    end
    ...
    methods
        ...
        function set.Clear(obj, clear)
            ...
            validateattributes(clear, {'logical', 'numeric'}, {'nonempty', 'scalar'}, 'ThrottleCmd', 'Clear');
