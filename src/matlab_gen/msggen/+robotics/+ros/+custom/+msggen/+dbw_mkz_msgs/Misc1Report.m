classdef Misc1Report < robotics.ros.Message
    ...
    properties (Constant, Hidden)
        MD5Checksum = 'c5c1e0d6ba52586919873bf9b0355143' % The MD5 Checksum of the message definition
    end
    ...
    properties (Constant, Hidden)
        PropertyList = {'AmbientLight', 'BtnCcCncl', 'BtnCcGapDec', 'BtnCcGapInc', 'BtnCcOff', 'BtnCcOn', 'BtnCcOnOff', 'BtnCcRes', 'BtnCcResCncl', 'BtnCcSetDec', 'BtnCcSetInc', 'BtnLaOnOff', 'BtnLdDown', 'BtnLdLeft', 'BtnLdOk', 'BtnLdRight', 'BtnLdUp', 'BuckleDriver', 'BucklePassenger', 'DoorDriver', 'DoorHood', 'DoorPassenger', 'DoorRearLeft', 'DoorRearRight', 'DoorTrunk', 'FaultBus', 'Header', 'HighBeamHeadlights', 'PassengerAirbag', 'PassengerDetect', 'TurnSignal', 'Wiper'} % List of non-constant message properties
        ROSPropertyList = {'ambient_light', 'btn_cc_cncl', 'btn_cc_gap_dec', 'btn_cc_gap_inc', 'btn_cc_off', 'btn_cc_on', 'btn_cc_on_off', 'btn_cc_res', 'btn_cc_res_cncl', 'btn_cc_set_dec', 'btn_cc_set_inc', 'btn_la_on_off', 'btn_ld_down', 'btn_ld_left', 'btn_ld_ok', 'btn_ld_right', 'btn_ld_up', 'buckle_driver', 'buckle_passenger', 'door_driver', 'door_hood', 'door_passenger', 'door_rear_left', 'door_rear_right', 'door_trunk', 'fault_bus', 'header', 'high_beam_headlights', 'passenger_airbag', 'passenger_detect', 'turn_signal', 'wiper'} % List of non-constant ROS message properties
    end
    ...
    methods
        ...
        function btnldok = get.BtnLdOk(obj)
            %get.BtnLdOk Get the value for property BtnLdOk
            btnldok = logical(obj.JavaMessage.getBtnLdOk);
        end
        
        function set.BtnLdOk(obj, btnldok)
            %set.BtnLdOk Set the value for property BtnLdOk
            validateattributes(btnldok, {'logical', 'numeric'}, {'nonempty', 'scalar'}, 'Misc1Report', 'BtnLdOk');
            
            obj.JavaMessage.setBtnLdOk(btnldok);
        end
        
        function btnldup = get.BtnLdUp(obj)
            %get.BtnLdUp Get the value for property BtnLdUp
            btnldup = logical(obj.JavaMessage.getBtnLdUp);
        end
        
        function set.BtnLdUp(obj, btnldup)
            %set.BtnLdUp Set the value for property BtnLdUp
            validateattributes(btnldup, {'logical', 'numeric'}, {'nonempty', 'scalar'}, 'Misc1Report', 'BtnLdUp');
            
            obj.JavaMessage.setBtnLdUp(btnldup);
        end
        
        function btnlddown = get.BtnLdDown(obj)
            %get.BtnLdDown Get the value for property BtnLdDown
            btnlddown = logical(obj.JavaMessage.getBtnLdDown);
        end
        
        function set.BtnLdDown(obj, btnlddown)
            %set.BtnLdDown Set the value for property BtnLdDown
            validateattributes(btnlddown, {'logical', 'numeric'}, {'nonempty', 'scalar'}, 'Misc1Report', 'BtnLdDown');
            
            obj.JavaMessage.setBtnLdDown(btnlddown);
        end
        
        function btnldleft = get.BtnLdLeft(obj)
            %get.BtnLdLeft Get the value for property BtnLdLeft
            btnldleft = logical(obj.JavaMessage.getBtnLdLeft);
        end
        
        function set.BtnLdLeft(obj, btnldleft)
            %set.BtnLdLeft Set the value for property BtnLdLeft
            validateattributes(btnldleft, {'logical', 'numeric'}, {'nonempty', 'scalar'}, 'Misc1Report', 'BtnLdLeft');
            
            obj.JavaMessage.setBtnLdLeft(btnldleft);
        end
        
        function btnldright = get.BtnLdRight(obj)
            %get.BtnLdRight Get the value for property BtnLdRight
            btnldright = logical(obj.JavaMessage.getBtnLdRight);
        end
        
        function set.BtnLdRight(obj, btnldright)
            %set.BtnLdRight Set the value for property BtnLdRight
            validateattributes(btnldright, {'logical', 'numeric'}, {'nonempty', 'scalar'}, 'Misc1Report', 'BtnLdRight');
            
            obj.JavaMessage.setBtnLdRight(btnldright);
        end
    ...
    methods (Access = protected)
        ...
        function cpObj = copyElement(obj)
            ...
            cpObj.BtnLdOk = obj.BtnLdOk;
            cpObj.BtnLdUp = obj.BtnLdUp;
            cpObj.BtnLdDown = obj.BtnLdDown;
            cpObj.BtnLdLeft = obj.BtnLdLeft;
            cpObj.BtnLdRight = obj.BtnLdRight;
        ...
        function reload(obj, strObj)
            ...
            obj.BtnLdOk = strObj.BtnLdOk;
            obj.BtnLdUp = strObj.BtnLdUp;
            obj.BtnLdDown = strObj.BtnLdDown;
            obj.BtnLdLeft = strObj.BtnLdLeft;
            obj.BtnLdRight = strObj.BtnLdRight;
    ...
    methods (Access = ?robotics.ros.Message)
        function strObj = saveobj(obj)
            ...
            strObj.BtnLdOk = obj.BtnLdOk;
            strObj.BtnLdUp = obj.BtnLdUp;
            strObj.BtnLdDown = obj.BtnLdDown;
            strObj.BtnLdLeft = obj.BtnLdLeft;
            strObj.BtnLdRight = obj.BtnLdRight;
