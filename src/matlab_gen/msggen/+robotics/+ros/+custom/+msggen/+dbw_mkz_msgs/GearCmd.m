classdef GearCmd < robotics.ros.Message
    ...
    properties (Constant, Hidden)
        MD5Checksum = '14694bb9a291d2a80b8033843d95776e' % The MD5 Checksum of the message definition
    end
    ...
    properties (Constant, Hidden)
        PropertyList = {'Clear', 'Cmd'} % List of non-constant message properties
        ROSPropertyList = {'clear', 'cmd'} % List of non-constant ROS message properties
    end
    ...
    methods
        ...
        function set.Clear(obj, clear)
            ...
            validateattributes(clear, {'logical', 'numeric'}, {'nonempty', 'scalar'}, 'GearCmd', 'Clear');
