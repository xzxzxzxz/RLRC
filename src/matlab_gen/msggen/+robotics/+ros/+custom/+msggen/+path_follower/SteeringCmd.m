classdef SteeringCmd < robotics.ros.Message
    %SteeringCmd MATLAB implementation of path_follower/SteeringCmd
    ...
    properties (Constant)
        MessageType = 'path_follower/SteeringCmd' % The ROS message type
    end
    
    properties (Constant, Hidden)
        MD5Checksum = 'ff1fa11624bdc2aff2aeee5aa6014057' % The MD5 Checksum of the message definition
    end
    ...
    properties (Constant, Hidden)
        PropertyList = {'Clear', 'Count', 'Enable', 'Ignore', 'Quiet', 'SteeringWheelAngleCmd', 'SteeringWheelAngleVelocity'} % List of non-constant message properties
        ROSPropertyList = {'clear', 'count', 'enable', 'ignore', 'quiet', 'steering_wheel_angle_cmd', 'steering_wheel_angle_velocity'} % List of non-constant ROS message properties
    end
    ...
    methods
        ...
        function clear = get.Clear(obj)
            %get.Clear Get the value for property Clear
            clear = logical(obj.JavaMessage.getClear);
        end
        
        function set.Clear(obj, clear)
            %set.Clear Set the value for property Clear
            validateattributes(clear, {'logical', 'numeric'}, {'nonempty', 'scalar'}, 'SteeringCmd', 'Clear');
            
            obj.JavaMessage.setClear(clear);
        end
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.path_follower.SteeringCmd.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.path_follower.SteeringCmd;
            obj.reload(strObj);
        end
    end
end
