...
extern SimulinkSubscriber<geometry_msgs::Pose2D, SL_Bus_DOB_ros_geometry_msgs_Pose2D> Sub_DOB_ros_174;
...
extern SimulinkPublisher<geometry_msgs::Pose2D, SL_Bus_DOB_ros_geometry_msgs_Pose2D> Pub_DOB_ros_158;
