...
// Conversions between SL_Bus_DOB_ros_const_controller_DobInfo and controller::DobInfo

void convertFromBus(controller::DobInfo* msgPtr, SL_Bus_DOB_ros_const_controller_DobInfo const* busPtr)
{
...
void convertToBus(SL_Bus_DOB_ros_const_controller_DobInfo* busPtr, controller::DobInfo const* msgPtr)
{
  const std::string rosMessageType("controller/DobInfo");
...
// Conversions between SL_Bus_DOB_ros_const_controller_TrackingInfo and controller::TrackingInfo

void convertFromBus(controller::TrackingInfo* msgPtr, SL_Bus_DOB_ros_const_controller_TrackingInfo const* busPtr)
{
  ...
  msgPtr->dy =  busPtr->Dy;
  msgPtr->K =  busPtr->K;
  msgPtr->K12 =  busPtr->K12;
  msgPtr->kappa =  busPtr->Kappa;
  msgPtr->Q =  busPtr->Q;
  msgPtr->v =  busPtr->V;
}

void convertToBus(SL_Bus_DOB_ros_const_controller_TrackingInfo* busPtr, controller::TrackingInfo const* msgPtr)
{
  const std::string rosMessageType("controller/TrackingInfo");
...
// Conversions between SL_Bus_DOB_ros_const_dbw_mkz_msgs_SteeringCmd and dbw_mkz_msgs::SteeringCmd

void convertFromBus(dbw_mkz_msgs::SteeringCmd* msgPtr, SL_Bus_DOB_ros_const_dbw_mkz_msgs_SteeringCmd const* busPtr)
{
...
void convertToBus(SL_Bus_DOB_ros_const_dbw_mkz_msgs_SteeringCmd* busPtr, dbw_mkz_msgs::SteeringCmd const* msgPtr)
{
  const std::string rosMessageType("dbw_mkz_msgs/SteeringCmd");
...
// Conversions between SL_Bus_DOB_ros_const_dbw_mkz_msgs_SteeringReport and dbw_mkz_msgs::SteeringReport

void convertFromBus(dbw_mkz_msgs::SteeringReport* msgPtr, SL_Bus_DOB_ros_const_dbw_mkz_msgs_SteeringReport const* busPtr)
{
...
void convertToBus(SL_Bus_DOB_ros_const_dbw_mkz_msgs_SteeringReport* busPtr, dbw_mkz_msgs::SteeringReport const* msgPtr)
{
  const std::string rosMessageType("dbw_mkz_msgs/SteeringReport");
...
// Conversions between SL_Bus_DOB_ros_const_ros_time_Time and ros::Time

void convertFromBus(ros::Time* msgPtr, SL_Bus_DOB_ros_const_ros_time_Time const* busPtr)
{
...
void convertToBus(SL_Bus_DOB_ros_const_ros_time_Time* busPtr, ros::Time const* msgPtr)
{
  const std::string rosMessageType("ros_time/Time");
...
// Conversions between SL_Bus_DOB_ros_const_std_msgs_Header and std_msgs::Header

void convertFromBus(std_msgs::Header* msgPtr, SL_Bus_DOB_ros_const_std_msgs_Header const* busPtr)
{
...
void convertToBus(SL_Bus_DOB_ros_const_std_msgs_Header* busPtr, std_msgs::Header const* msgPtr)
{
  const std::string rosMessageType("std_msgs/Header");
